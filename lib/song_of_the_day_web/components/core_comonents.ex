defmodule SongOfTheDayWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SongOfTheDayWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SongOfTheDayWeb.Gettext, "errors", msg, opts)
    end
  end
